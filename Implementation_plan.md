...
- [ ] Port process/terminal agent detection using Herdr's manifests and state
  ...
  direct and wrapped Pi/Qoder CLI/Droid/Kiro/Claude/Codex/Gemini/OpenCode/
  GitHub Copilot processes, Herdr-aligned Pi `Working...`, Qoder CLI and Droid
  blocker/working cues, Kiro blocker/working/idle cues, and Copilot selection blocker,
