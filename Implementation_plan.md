...
- [ ] Port process/terminal agent detection using Herdr's manifests and state
  ...
  Recent Amp, Cline, Cursor, Devin, Droid, Kilo, Kiro, Kimi, and Qoder CLI rule functions are now grouped under
  `src/detect/agents/`, matching Herdr's per-agent manifest organization.
  direct and wrapped Pi/Qoder CLI/Droid/Kilo/Kiro/Kimi/Cline/Devin/Cursor/Amp/Claude/Codex/Gemini/
  ...
  cues, Kilo permission/interrupt cues, and Copilot selection blocker,
