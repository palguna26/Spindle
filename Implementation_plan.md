...
- [ ] Port process/terminal agent detection using Herdr's manifests and state
  ...
  Recent Amp, Antigravity, Cline, Cursor, Devin, Droid, Hermes, Kilo, Kiro, Kimi, and Qoder CLI rule functions are now grouped under
  `src/detect/agents/`, matching Herdr's per-agent manifest organization.
  direct and wrapped Pi/Qoder CLI/Droid/Hermes/Kilo/Kiro/Kimi/Cline/Devin/Cursor/Amp/Antigravity/Claude/Codex/Gemini/
  ...
  blocker cues, and Copilot selection blocker,
