...
- [ ] Port process/terminal agent detection using Herdr's manifests and state
  ...
  Codex, OpenCode, Gemini, Cline, GitHub Copilot, Pi, Qoder CLI, Droid, Devin, Cursor, Amp, Antigravity, Kilo, Hermes, Kiro, Kimi, Maki, Muse, Grok, and Qwen now use a shared
