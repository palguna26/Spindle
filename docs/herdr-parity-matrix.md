...
Codex/OpenCode/Gemini/Cline/Copilot/Pi/Qoder CLI/Droid detection parity note: `src/detect/manifest.rs` now
...
and Droid’s selection-menu, stop-hint, and spinner rules.
