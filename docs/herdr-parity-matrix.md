...
Codex/OpenCode/Gemini/Cline/Copilot/Pi/Qoder CLI/Droid/Devin/Cursor/Amp/Antigravity detection parity note: `src/detect/manifest.rs` now
...
permission, spinner, and background-task rules.
