...
Codex/OpenCode/Gemini/Cline/Copilot/Pi/Qoder CLI/Droid/Devin/Cursor/Amp/Antigravity/Kilo/Hermes detection parity note: `src/detect/manifest.rs` now
...
credential, confirmation, interrupt, cancel, and idle rules.
