...
Codex/OpenCode/Gemini/Cline/Copilot/Pi/Qoder CLI/Droid/Devin detection parity note: `src/detect/manifest.rs` now
...
permission, working-footer, and idle-prompt rules.
