...
Codex/OpenCode/Gemini/Cline/Copilot/Pi/Qoder CLI/Droid/Devin/Cursor/Amp/Antigravity/Kilo/Hermes/Kiro detection parity note: `src/detect/manifest.rs` now
...
tool-approval, subagent-approval, idle-prompt, and spinner rules.
