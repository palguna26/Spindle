...
Codex/OpenCode/Gemini/Cline/Copilot/Pi/Qoder CLI/Droid/Devin/Cursor/Amp/Antigravity/Kilo/Hermes/Kiro/Kimi/Maki/Muse detection parity note: `src/detect/manifest.rs` now
...
working, and idle fallback rules.
