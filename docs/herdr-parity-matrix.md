...
| Discover and use keyboard and mouse controls | Partial | `docs/preview/website/src/content/docs/quick-start.mdx`, `docs/preview/website/src/content/docs/keyboard.mdx` | `Ctrl-b ?` opens an in-app guide; `Ctrl-b :` opens the command palette; `Ctrl-b z` zooms the focused pane like Herdr. The guide covers supported mouse and keyboard controls. Full keyboard equivalents for every menu action and manual Windows verification remain. |
