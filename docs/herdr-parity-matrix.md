...
Codex/OpenCode/Gemini detection parity note: `src/detect/manifest.rs` now
...
confirmation controls, interrupt hints, progress bars, and stale-scrollback
tests. Other agent detectors remain on compatibility functions until migrated
