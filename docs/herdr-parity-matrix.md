...
| Select/copy terminal text and route terminal mouse input | Partial | `src/selection.rs`, `src/client/shell/mouse.rs` | Spindle tracks app-requested mouse modes and forwards supported SGR/legacy events, with right-click passthrough opt-in. Drag-select/copy and live Windows Terminal verification remain. |
