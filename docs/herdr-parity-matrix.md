...
Codex/OpenCode/Gemini/Cline detection parity note: `src/detect/manifest.rs` now
...
bars, and stale-scrollback tests. Other agent detectors remain on compatibility
functions until migrated to the shared evaluator.
