...
| Discover and use keyboard and mouse controls | Partial | `src/main.rs` `[keys]`, `docs/preview/website/src/content/docs/keyboard.mdx` | Spindle now matches Herdr's defaults for `Ctrl-b c` new tab, `Ctrl-b x` close pane, `Ctrl-b Shift+x` close tab, `Ctrl-b n/p` tab navigation, `Ctrl-b v/-` splits, `Ctrl-b h/j/k/l` pane focus, and `Ctrl-b z` zoom. Its in-app guide lists the shortcuts. Extra menu actions, configurable bindings, and manual Windows verification remain. |
