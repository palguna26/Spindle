...
Codex/OpenCode/Gemini/Cline/Copilot/Pi/Qoder CLI/Droid/Devin/Cursor/Amp detection parity note: `src/detect/manifest.rs` now
...
OSC-title, approval, footer, cancel, and idle rules.
