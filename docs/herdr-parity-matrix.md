...
Codex/OpenCode/Gemini/Cline/Copilot detection parity note: `src/detect/manifest.rs` now
...
bars, background-agent cues, and stale-scrollback tests. Other agent detectors
remain on compatibility functions until migrated to the shared evaluator.
